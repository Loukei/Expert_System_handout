...
(defrule MAIN::Openfile
 ...
 =>
 (open "result-M0154013v3.txt" mydata "w")
 (printout t "open file result-M0154013v3.txt" crlf)
)
...
(defrule MAIN::CloseFile
 (declare (salience -50) )
 =>
 (close result-M0154013v3.txt)
 (printout t "close file result-M0154013v3.txt" crlf)
)
